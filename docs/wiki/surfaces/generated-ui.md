...
`surfacesHandler` in `services/control-api/src/surfaces.ts` (replacing the earlier 501 stub). Routes at `control-api-stack.ts:309-322`:
...
Neither command-center nor work-dashboard renders an A2UI message.
